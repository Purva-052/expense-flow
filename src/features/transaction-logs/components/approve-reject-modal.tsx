...
export function ApproveRejectModal({
  ...
  const handleApprove = () => {
    setPendingAction({ status: "approved" });
  ...
  return (
    <>
      ...
      <SecurityPasswordDialog
        ...
        description={`Please enter the privacy password to ${pendingAction?.status === "approved" ? "approve" : "reject"} this transaction request.`}
