...
import { useGetVenueTypesData } from './services'

const VenueTypesPage = () => {
  const { open, setOpen } = useVenueTypeStore()
  ...
  const { data: listData, isPending: loading } = useGetVenueTypesData(apiParams)
  ...
  return (
    <PageLayout>
      <TablePageHeader
        title='Venue Types'
        buttonText='Add Venue Types'
        onButtonClick={handleAdd}
      >
        Manage your Venue Types here.
      </TablePageHeader>
