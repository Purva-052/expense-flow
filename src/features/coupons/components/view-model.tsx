...
export function ViewCouponModal() {
  const { open, setOpen, currentRow } = useCouponsStore()
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{currentRow.discountPercentage}%</p>
          </div>
          <div>
            <h3 className="text-sm font-medium">Max Discount</h3>
            <p className="text-sm text-gray-600">{currentRow.maxDiscountAmount}</p>
          </div>
          <div>
