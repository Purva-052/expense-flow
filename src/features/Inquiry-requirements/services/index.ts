...
export const useCreateInquiryRequirement = () => {
  const { setOpen } = useInquiryRequirementStore();
  return usePostData({
...
export const useUpdateInquiryRequirement = (id: string) => {
  const { setOpen } = useInquiryRequirementStore();
  return usePatchData({
...
export const useGetInquiryRequirement = (params?: any) => {
  return useFetchData({ url: GET_API_URL, params });
};

export const useDeleteInquiryRequirement = (id: string) => {
  const { setOpen } = useInquiryRequirementStore();
